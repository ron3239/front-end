...
const reviews = [
  ...
  { id: 3, avatar: '/images/ava3.jpg', name: 'Плюшик', status: 'Был(а) 5 минут назад', text: 'Все быстро, качественно, дешево. Покупайте у @q0unique0', time: '12:34' },
  ...
  { id: 5, avatar: '/images/ava5.jpg', name: 'Dofamine', status: 'Был(а) недавно', text: 'Сделал очень быстро и четко, рекомендую данного человека, почаще буду покупать звезды', time: '09:59' },
      ...
      <div className={styles.container}>
        <div className={styles.reviews__navigation}>
          ...
          <div className={styles.swiperContainer}>
            <div className={styles.swiperWrapper} style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
              {reviews.map((review) => (
                <div 
                  key={review.id} 
